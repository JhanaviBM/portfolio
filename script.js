...
const projectData = [
    ...
    { title: "Daily Sleep Tracker", description: "The Daily Sleep Tracker is a web application built using Java, React, and MySQL to help users monitor and manage their sleep patterns. With a user-friendly interface, it allows individuals to log their daily sleep hours and provides visual insights into their sleep habits through charts and summaries. The app includes features for setting sleep goals, tracking sleep consistency, and analyzing patterns to promote better sleep hygiene. By offering an organized and interactive way to manage sleep data, it helps users work towards healthier sleep routines."},
];
