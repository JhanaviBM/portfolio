...
const projectData = [
    ...
    { title: "Daily Sleep Tracker", description: "The Password Strength Checker is a Java-based application designed to assess the security level of user-entered passwords. It features a clean, intuitive interface where users can input their passwords for evaluation. The system applies robust algorithms to analyze factors such as password length, the inclusion of uppercase and lowercase letters, numbers, and special characters. To provide instant feedback, it uses a color-coded system—red for weak passwords, yellow for moderate, and green for strong passwords—allowing users to easily understand the quality of their password. This tool promotes better password practices by encouraging the creation of stronger, more secure passwords."},
    { title: "Password Strength Checker", description: "The Daily Sleep Tracker is a web application built using Java, React, and MySQL to help users monitor and manage their sleep patterns. With a user-friendly interface, it allows individuals to log their daily sleep hours and provides visual insights into their sleep habits through charts and summaries. The app includes features for setting sleep goals, tracking sleep consistency, and analyzing patterns to promote better sleep hygiene. By offering an organized and interactive way to manage sleep data, it helps users work towards healthier sleep routines."},
];
